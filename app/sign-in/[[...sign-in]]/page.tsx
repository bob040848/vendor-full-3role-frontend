...
export default function SignInPage() {
  ...
  useEffect(() => {
    if (isLoaded && isSignedIn && user) {
      ...
      console.log("User role in sign-in:", userRole);
  ...
  if (isNavigating) {
    const userRole = user?.publicMetadata?.role as string;
    let message = "Амжилттай нэвтэрлээ. Шилжүүлж байна...";

    if (userRole === "ADMIN") {
      message = "Амжилттай нэвтэрлээ. Админ хуудас руу шилжүүлж байна...";
    } else if (userRole === "VENDOR") {
      message =
        "Амжилттай нэвтэрлээ. Борлуулагчийн хуудас руу шилжүүлж байна...";
    } else if (userRole === "USER") {
      message = "Амжилттай нэвтэрлээ. Эрх шалгаж байна...";
    }
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl p-6 sm:p-8 text-center">
            <div className="mb-6 sm:mb-8">
              ...
              <p className="text-gray-600 text-sm sm:text-base">
                MENA акаунт руугаа нэвтэрнэ үү
              </p>
            </div>
