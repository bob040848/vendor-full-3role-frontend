                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-gray-600 text-sm mb-3">
                            Бүтээгдэхүүн үйлдвэрлэдэг, нийлүүлдэг үйлдвэр,
                            дистрибьютеруудад зориулсан
                          </p>
                    ...
                    >
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-gray-600 text-sm mb-3">
                            Бүтээгдэхүүн худалдан авч, худалдаалаг дэлгүүр,
                            жижиглэнгийн худалдаачдад зориулсан
                          </p>
                          <ul className="text-xs text-gray-500 space-y-1">
                ...
                <div className="bg-white/90 rounded-2xl p-8">
                  ...
                  <div className="space-y-4">
                    <h3 className="font-semibold text-gray-800">
                      {selectedRole === "VENDOR"
                        ? "Худалдагчийн давуу тал:"
                        : "Дэлгүүрийн давуу тал:"}
                    </h3>
                    {selectedRole === "VENDOR" ? (
                      <div className="space-y-3">
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-gray-600 text-sm">
                              Бүтээгдэхүүний нөөц болон агуулахын түвшинг бүрэн
                              хянах
                            </p>
                          </div>
                        </div>
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-gray-600 text-sm">
                              Бизнесийн гүйцэтгэлийг нэмэгдүүлэх дэвшилтэт
                              тайлан болон аналитик
                            </p>
                          </div>
                        </div>
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-gray-600 text-sm">
                              Түгээлтийн суваг болон жижиглэнгийн худалдаачидтай
                              харилцах харилцааг удирдах
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-3">
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-gray-600 text-sm">
                              Олон төрлийн худалдагчийн бүтээгдэхүүнээс үзэж,
                              захиалах
                            </p>
                          </div>
                        </div>
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-gray-600 text-sm">
                              Захиалгаа хянаж, хүргэлтийг үр ашигтайгаар удирдах
                            </p>
                          </div>
                        </div>
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-gray-600 text-sm">
                              Дэлгүүрийн гүйцэтгэл болон борлуулалтын чиг
                              хандлагыг хянах
                            </p>
                          </div>
                        </div>
                ...
                {selectedRole ? (
                  ...
                  <div className="text-center py-12">
                    <p className="text-gray-500 mb-4">
                      Үргэлжлүүлэхийн тулд үүргээ сонгоно уу
                    </p>
                  ...
                  <div className="text-center">
                    ...
                    <div className="bg-orange-100 rounded-lg p-3">
                      <p className="font-medium text-orange-800">
                        {selectedRole === "VENDOR"
                          ? "Худалдагчийн танилцуулга"
                          : "Дэлгүүрийн танилцуулга"}
                      </p>
