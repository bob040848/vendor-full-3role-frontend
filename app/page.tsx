        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl p-6 sm:p-8 md:p-10 lg:p-12 mb-8 sm:mb-10 lg:mb-12">
            ...
            <p className="text-gray-600 mb-6 sm:mb-8 text-sm sm:text-base">
              Энэ портал нь борлуулагч болон дэлгүүрүүдэд зориулагдсан. 
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 text-left">
            ...
            <div className="bg-white rounded-lg sm:rounded-xl p-4 sm:p-6 shadow-lg">
              <h3 className="text-lg sm:text-xl font-semibold text-gray-800 mb-2 sm:mb-3">Дэлгүүрийн удирдлага</h3>
              <p className="text-gray-600 text-sm sm:text-base">Дэлгүүрийн захиалга, агуулах болон борлуулалтын удирдлагын систем.</p>
            </div>
            
            <div className="bg-white rounded-lg sm:rounded-xl p-4 sm:p-6 shadow-lg sm:col-span-2 lg:col-span-1">
              <h3 className="text-lg sm:text-xl font-semibold text-gray-800 mb-2 sm:mb-3">Нэгдсэн платформ</h3>
              <p className="text-gray-600 text-sm sm:text-base">Борлуулагч болон дэлгүүр хоорондын харилцааг хялбарчилсан нэг платформ.</p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="text-center">
                <div className="bg-orange-100 rounded-lg p-4 mb-3">
                  <h4 className="font-semibold text-orange-800">Борлуулагч / Үйлдвэрлэгч</h4>
                </div>
              ...
              <div className="text-center">
                <div className="bg-blue-100 rounded-lg p-4 mb-3">
                  <h4 className="font-semibold text-blue-800">Дэлгүүр / Жижиглэнгийн худалдаа</h4>
                </div>
                <p className="text-sm text-gray-600">
                  Бүтээгдэхүүн худалдан авч, борлуулдаг дэлгүүрүүдэд зориулагдсан
                </p>
              </div>
            </div>
          </div>
